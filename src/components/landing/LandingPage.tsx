    ...
    <section id="master" className="relative py-20 lg:py-24">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-10">
        <motion.div
          ...
          className="mobile-reveal mb-6 max-w-2xl transform-gpu"
        >
        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-[minmax(0,5fr)_minmax(0,7fr)] lg:gap-12 items-start">
          {/* Portrait */}
          <motion.div
...
export const TIERS = [
  {
    ...
    badge: "Basic",
    duration: "1 Month",
    bestFor: "Opening a shop in a normal or local area",
    features: [
      "OCA Machine",
      "OLED Programming",
      "Bubble Remover",
  ...
  },
  {
    ...
    bestFor: "Professionals aiming for full-board mastery",
    features: [
      "Includes Basic + Advance Level Training +",
      "Deep Sections: Battery, Charging, Sim, Signal, Network, Audio, Wifi, Power",
      "Practical IC Reballing",
      "IC Handling: Charging, Network, Power, PA, and Wifi ICs",
      "Practical Fault Tracing on PC Board",
      "And many more master-level board repair techniques…",
    ],
  },
] as const;
